#CODE AVEC SEULEMENT LE FILTRAGE
...
for x in range(0, x_new, 8):
    for y in range(0, y_new, 8):
        ...
        new_blocb=P @ bloc1b @ P_inv
        new_blocv=P @ bloc2v @ P_inv
        new_blocr=P @ bloc3r @ P_inv
...
for x in range(0, x_new, 8):
    for y in range(0, y_new, 8):
        bloc_compress1b=M_compressb[x:x+8, y:y+8]
        bloc_compress2v=M_compressv[x:x+8, y:y+8]
        bloc_compress3r=M_compressr[x:x+8, y:y+8]
